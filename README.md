...
- `execute_terminal_command` — execute a command in the terminal
    - Note: The `execute_terminal_command` tool is now protected with a safety policy (safe commands list) and includes user confirmation for potentially unsafe commands.
